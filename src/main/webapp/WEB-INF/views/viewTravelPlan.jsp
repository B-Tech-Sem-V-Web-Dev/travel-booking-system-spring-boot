...
<head>
    ...
    <title>Plans</title>
    <link rel="stylesheet" href="/csspages/bookingplanstyle.css">
</head>
<body>
    <div class="container">
    ...
    <%
        TravelPlans travelPlan=(TravelPlans) request.getAttribute("travelPlan");
        if (travelPlan != null) {
    %>
        ...
        <div class="plan">
            ...
            <div class="plandetails">
                <div class="field">
                    ...
                    <span class="value"><%= travelPlan.getId() %></span>
                </div>
    
                <div class="field">
                    <span class="label">Destination:</span>
                    <span class="value"><%= travelPlan.getDestination() %></span>
                </div>
                <%
                    TransportSchedules mediumOfTravel=(TransportSchedules) request.getAttribute("mediumOfTravel");
                    if (mediumOfTravel != null) {
                %>
                <div class="field">
                    <span class="label">Medium of Transport:</span>
                    <span class="value"><%= mediumOfTravel.getMedium() %></span>
                </div>
    
                <div class="field">
                    <span class="label">Source and Destination:</span>
                    <span class="value"><%= mediumOfTravel.getSource()%> | <%= mediumOfTravel.getDestination() %> </span>
                </div>
    
                <div class="field">
                    <span class="label">Departure time</span>
                    <span class="value"><%= mediumOfTravel.getDepartureTime()%> </span>
                </div>
    
                <div class="field">
                    <span class="label">Arrival time:</span>
                    <span class="value"><%= mediumOfTravel.getArrivalTime() %></span>
                </div>
                <%
                    }
                %>
