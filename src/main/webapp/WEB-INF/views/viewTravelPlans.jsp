...
<body>
    ...
    <%
        TravelPlans currentPlan=(TravelPlans) request.getAttribute("currentPlan");
        if (currentPlan != null) {
    %>
        ...
        <div class="plan">
            ...
            <div class="plandetails">
                <div class="field">
                    ...
                    <span class="value"><%= currentPlan.getId() %></span>
                </div>
    
                <div class="field">
                    <span class="label">Destination:</span>
                    <span class="value"><%= currentPlan.getDestination() %></span>
                </div>
    ...
    <div class="previousplan">
        ...
        <div class="plan">
            ...
            <div class="plandetails">
                <div class="field">
                    <span class="label">Trip Id:</span>
                    <span class="value"><%= plan.getId() %></span>
                </div>
    
                <div class="field">
                    <span class="label">Destination:</span>
                    <span class="value"><%= plan.getDestination() %></span>
                </div>
